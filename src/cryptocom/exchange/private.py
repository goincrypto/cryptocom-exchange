...
class Account:
    ...
    async def get_orders_history(self, pair: Pair=None, page: int=0,
    ...
    async def get_open_orders(self, pair: Pair=None, page: int=0,
            page_size: int=200) -> List[Order]:
        """Return open orders."""
        if pair:
            params = {
    ...
    async def get_trades(self, pair: Pair=None, page: int=0,
