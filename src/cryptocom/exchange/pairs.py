...
BASECAT_USD = Pair(
    exchange_name="BASECAT_USD",
    price_precision=6,
    quantity_precision=0,
    inst_type=InstrumentType.SPOT,
    display_name="BASECAT/USD",
    base_currency=Instrument("BASECAT"),
    quote_currency=Instrument("USD"),
    quantity_tick_size=10.0,
    price_tick_size=1e-06,
    min_order_quantity=0.0,
...
PONS_USD = Pair(
    exchange_name="PONS_USD",
    price_precision=5,
    quantity_precision=0,
    inst_type=InstrumentType.SPOT,
    display_name="PONS/USD",
    base_currency=Instrument("PONS"),
    quote_currency=Instrument("USD"),
    quantity_tick_size=1.0,
    price_tick_size=1e-05,
    min_order_quantity=0.0,
